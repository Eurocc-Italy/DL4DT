...
def DL4DT(path_Y,path_D,path_X,c=None,s=None,n=None,max_iter=10,jobs=1,verb=0):
...
def main():
  ...
  DL4DT(args.path_Y,args.path_D,args.path_X,args.c,args.s,args.n,args.max_iter,args.jobs,args.verb)
